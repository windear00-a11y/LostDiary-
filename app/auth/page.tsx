    ...
    <main className="min-h-screen bg-[#0d0d0d] text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="space-y-2">
          ...
          <p className="text-lg text-slate-400 font-serif italic">Your story is waiting.</p>
        </div>
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full bg-white text-black py-4 rounded-full font-medium hover:bg-slate-200 transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-3 text-sm"
          >
          ...
          <button
            className="w-full bg-slate-800 text-white py-4 rounded-full font-medium hover:bg-slate-700 transition-all hover:scale-[1.02] active:scale-[0.98] text-sm"
          >
            Continue with OTP
          </button>
        </div>
